...
> 本專案基於 Minidoracat 的 **mcp-feedback-enhanced**，其最初 fork 自 Fábio Ferreira 的 **interactive-feedback-mcp**。
> UI 設計參考自 sanshao85 的 **mcp-feedback-collector**。
...
本專案站在巨人的肩膀上，感謝原作者以及所有上游貢獻者：

- **Fábio Ferreira** — 原始專案 **interactive-feedback-mcp** 的作者
- **Minidoracat** — **mcp-feedback-enhanced** 的作者，也是本 fork 的直接上游
- **sanshao85** — UI 設計靈感來源 **mcp-feedback-collector**
